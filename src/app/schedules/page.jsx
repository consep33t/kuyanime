        ...
        <div className="w-full p-5 rounded-sm flex flex-wrap lg:flex-nowrap bg-white border-b-2">
          <button
            className={`hover:text-green w-full text-center capitalize rounded-sm p-1 text-sm focus:text-white focus:bg-green ${
              filter === "senin" ? "bg-green text-white" : ""
            }`}
          ...
          <button
            className={`hover:text-green w-full text-center capitalize rounded-sm p-1 text-sm focus:text-white focus:bg-green ${
              filter === "tuesday" ? "bg-green text-white" : ""
            }`}
          ...
          <button
            className={`hover:text-green w-full text-center capitalize rounded-sm p-1 text-sm focus:text-white focus:bg-green ${
              filter === "wednesday" ? "bg-green text-white" : ""
            }`}
          ...
          <button
            className={`hover:text-green w-full text-center capitalize rounded-sm p-1 text-sm focus:text-white focus:bg-green ${
              filter === "thursday" ? "bg-green text-white" : ""
            }`}
          ...
          <button
            className={`hover:text-green w-full text-center capitalize rounded-sm p-1 text-sm focus:text-white focus:bg-green ${
              filter === "friday" ? "bg-green text-white" : ""
            }`}
          ...
          <button
            className={`hover:text-green w-full text-center capitalize rounded-sm p-1 text-sm focus:text-white focus:bg-green ${
              filter === "Saturday" ? "bg-green text-white" : ""
            }`}
          ...
          <button
            className={`hover:text-green w-full text-center capitalize rounded-sm p-1 text-sm focus:text-white focus:bg-green ${
              filter === "Sunday" ? "bg-green text-white" : ""
            }`}
          ...
          <button
            className={`hover:text-green w-full text-center capitalize rounded-sm p-1 text-sm focus:text-white focus:bg-green ${
              filter === "unknown" ? "bg-green text-white" : ""
            }`}
          ...
          <button
            className={`hover:text-green w-full text-center capitalize rounded-sm p-1 text-sm focus:text-white focus:bg-green ${
              filter === "other" ? "bg-green text-white" : ""
            }`}
