...
const BtnTopAnime = ({ setSliceRange }) => {
  return (
    <div className="flex justify-between">
      <button
        className="hover:text-green rounded-sm px-8 py-1 text-xs focus:text-white focus:bg-green"
        onClick={() => setSliceRange(0, 5)}
      >
        0-4
      </button>
      <button
        className="hover:text-green rounded-sm px-8 py-1 text-xs focus:text-white focus:bg-green"
        onClick={() => setSliceRange(5, 10)}
      >
        5-10
      </button>
      <button
        className="hover:text-green rounded-sm px-8 py-1 text-xs focus:text-white focus:bg-green"
        onClick={() => setSliceRange(10, 15)}
      >
        11-15
      </button>
    </div>
...
const TopAnime = () => {
  ...
  return (
    <div className="">
      <div>
        <h3 className="border-b text-sm font-bold p-2 capitalize">
          anime terpopuler
        </h3>
      </div>
